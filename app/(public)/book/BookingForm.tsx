  ...
  return (
    <form onSubmit={submit} className="artistic-booking-form">
      ...
      <div className="booking-section-title">
        ...
        <h3>Selecciona el estilo de referencia</h3>
        ...
        {STYLES_INSPIRATION.map((style) => (
          ...
          >
            <div className="style-card-image">
              <Image src={style.image} alt={style.title} width={680} height={840} sizes="(max-width: 700px) 100vw, 50vw" />
      ...
      <div className="booking-section-title" style={{ marginTop: "48px" }}>
